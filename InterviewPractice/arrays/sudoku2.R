...
#finer relevation: even matrix is not required. the slowing thing was the lapply to make things numeric. takes
#some milliseconds. It is quite unique,because when we dont do this, we still do row,column and box wise
# checks for non-dot entries, and thats fine. 
